...
namespace DialogueSystem
{
    ...
    public class Talk
    {
        ...
        public Talk(string text, string tag, string characterName = null, List<Answer> answers = null) : this(text, tag, characterName)
        {
            this.answers = answers;
        }

        public Talk(string text, string tag, string characterName = null, params Answer[] inputAnswers) : this(text, tag, characterName)
        {
            foreach (Answer answer in inputAnswers) answers.Add(answer);
        }

        public Talk(string text, string tag, string characterName = null, List<Answer> answers = null, List<Modifier> modifiers = null) : this(text, tag, characterName)
        {
            if (answers != null) this.answers = answers;
            if (modifiers != null) this.modifiers = modifiers;
        }

        public Talk(string text, string tag, string characterName = null, List<Answer> answers = null, List<Modifier> modifiers = null, List<DialogueAction> actions = null) : this(text, tag, characterName, answers, modifiers)
        {
            if (actions != null) this.unconditionalActions = actions;
        }

        public Talk(string text, string tag, string characterName = null, List<Answer> answers = null, List<Modifier> modifiers = null, params DialogueAction[] inputActions) : this(text, tag, characterName, answers, modifiers)
        {
